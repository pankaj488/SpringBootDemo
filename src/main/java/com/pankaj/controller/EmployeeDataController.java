...
import com.pankaj.model.EmployeeAddress;
import com.pankaj.model.EmployeeAddresses;
import com.pankaj.model.EmployeeName;
...
public class EmployeeDataController 
{
    ...
    public EmployeeAddresses getAddresses() 
    {
        ...
        /*
        EmployeeAddresses e = new EmployeeAddresses();
		
		 * Boolean flag = false; if (!flag) { throw new NullPointerException(); }
		 */
       
		
		  EmployeeAddresses employeeAddressesList = new EmployeeAddresses();
		  
		  EmployeeAddress employeeAddress1 = new EmployeeAddress(); EmployeeAddress
		  employeeAddress2 = new EmployeeAddress();
		  
		  List<EmployeeAddress> addressList = new ArrayList<EmployeeAddress>();
		  
		  { employeeAddress1.setHouseNo("1111"); employeeAddress1.setStreetNo("111");
		  employeeAddress1.setZipCode("111111");
		  
		  employeeAddress2.setHouseNo("222"); employeeAddress2.setStreetNo("222");
		  employeeAddress2.setZipCode("222222");
		  
		  addressList.add(employeeAddress1); addressList.add(employeeAddress2);
